...
// <<<<<<<<<<<<<<<<< MAP & FILTER FUNCTIONS <<<<<<<<<<<<<<<<<
 // TODO #2: Filter all dishes for those that have a cuisine type of Italian
    ...
    function searchCuisines(allDishes) {
        ...
        let userInput = prompt("Enter the your favorite cuisine..")
        let results = allDishes.filter(function (el) {
...
function searchIngredients(allDishes) {
    ...
    let userInput = prompt("Enter a ingredient for your dish")
    let results = allDishes.filter(function (el) {
...
function generateCuisineDishName(allDishes) {
    ...
    let userInputCuisine = prompt("Enter your cuisine name!")
    let userInputDish = prompt("Enter your dish name!")
    let results = allDishes.filter(function (el) {
        return el.cuisine === userInputCuisine && el.name === userInputDish;
...
function emailMessage(dishOfTheDay) {
    ...
    let cuisine ="Italian"
    let dish = "Spaghetti Bolognese";
    let email = cuisine +""+ dish
